...
//  CCRegexDemo
//
//  Created by dengyouhua on 2018/6/26.
...
RKL_STATIC_INLINE id    rkl_CreateAutoreleasedArray   (void **objects, NSUInteger count)                         { return(rkl_CFAutorelease(CFBridgingRetain(rkl_CreateArrayWithObjects(objects, count)))); }
